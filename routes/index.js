...
router.get('/', function(req, res, next) {
    ...
    const adminEmails = `remilekunelijah21997@yahoo.com,
        juwonofficial@yahoo.com, ewmrhumr@yowamusic.com.ng `;
    ...
    async function main() {
        ...
        let adminMsg = await transporter.sendMail({
            from: `
            "Yowa Music" < ewmrhumr @yowamusic.com.ng > `, // sender address
        ...
        console.log("Message sent: %s", `${adminMsg.messageId} ${adminEmails}`);
        ...
        res.render("home", { title: req.body.name });
